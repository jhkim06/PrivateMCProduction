...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/EGM-RunIISpring18wmLHEGS-00001-fragment.py nevts:100'),
...
process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(1561704484%100)
