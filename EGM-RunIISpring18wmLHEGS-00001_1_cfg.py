...
process.maxEvents = cms.untracked.PSet(
    input = cms.untracked.int32(1338)
)
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/EGM-RunIISpring18wmLHEGS-00001-fragment.py nevts:1338'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    ...
    nEvents = cms.untracked.uint32(1338),
...
process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(1567593995%100)
